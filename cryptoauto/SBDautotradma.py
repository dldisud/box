...
access = "J2uvBQSScT3xIVTXYGxCChD8NXneinvo5mQACgxy"
secret = "e4XG6xxHSJlxcaUMf7tx5NVrZ7kxg4LleBW1QOcD"
myToken = "xoxb-1628718439154-1641359396593-te1tSEWz7tDN2HLIUkeQligg"
    ...
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_price < current_price and ma15 < current_price:
                krw = get_balance("KRW")
                if krw > 5000:
                    buy_result = upbit.buy_market_order("KRW-SBD", krw*0.9995)
